...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://autofilter:autofilter@cluster0.s2yvn.mongodb.net/?retryWrites=true&w=majority")  # MongoDB URI for the database
