...
API_ID = int(environ.get('API_ID', '21606847')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'b9708b698eed88f053454aed2598e571')  # API Hash from my.telegram.org
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002016227618'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001521000125'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001521000125'))  # Premium logs channel id
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002072782451")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://stockpartners0416:Z52LH686FLCZ6JlX@cluster0.srrkv3r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/wolverine273') # Update channel link for the bot
...
if HAS_SSL:
    URL = "https://linear-elizabet-misslazy-2352602e.koyeb.app/".format(FQDN)
else:
    URL = "https://linear-elizabet-misslazy-2352602e.koyeb.app/".format(FQDN)
