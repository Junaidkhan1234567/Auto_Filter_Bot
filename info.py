...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://baby_bot:baby_bot@cluster0.l1eovah.mongodb.net/?retryWrites=true&w=majority")  # MongoDB URI for the database
