...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://babybot:babybot121@cluster0.l1eovah.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', 'fc1fef96') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
PREMIUM_LOGS = int(environ.get("PREMIUM_LOGS", "-1001521000125"))
...
if HAS_SSL:
    URL = "https://rural-sherilyn-nikkulazy-5bf36bd3.koyeb.app/".format(FQDN)
else:
    URL = "https://rural-sherilyn-nikkulazy-5bf36bd3.koyeb.app/".format(FQDN)
