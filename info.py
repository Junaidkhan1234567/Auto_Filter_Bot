...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002081930046'))  # Notification of sent to your channel
...
if HAS_SSL:
    URL = "https://clumsy-cindi-tuheed-191b5543.koyeb.app/".format(FQDN)
else:
    URL = "https://clumsy-cindi-tuheed-191b5543.koyeb.app/".format(FQDN)
