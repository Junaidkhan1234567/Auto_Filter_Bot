...
warn_msg = await message.reply_photo(
    photo="https://i.imgur.com/zU3M6kU.jpg",
    caption=(
        f"⚠️ Hey {message.from_user.mention},\n\n"
        f"🚫 Your daily file download limit has been reached!\n\n"
        f"💎 Upgrade to Premium to remove all limits and enjoy unlimited downloads."
    ),
    reply_markup=reply_markup
)
